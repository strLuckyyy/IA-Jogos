...
{
    // -------------------------------------------------------
    // Parâmetros ajustáveis no Inspector do Unity
    // -------------------------------------------------------
    [Header("Percepção")]
    ...
    // -------------------------------------------------------
    // Init – chamado uma vez ao inicializar o comportamento
    // -------------------------------------------------------
    ...
    // -------------------------------------------------------
    // Execute – chamado todo FixedUpdate pelo SnakeMovement
    // -------------------------------------------------------
    public override void Execute()
    {
        ...
        switch (currentState)
        {
            ...
            case BotState.Wander:
                ...
                // Troca ponto de wander se chegou perto o suficiente
